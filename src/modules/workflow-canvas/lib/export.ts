...
export const exportCanvasAsIdacTemplateExcel = (
  ...
  const firewallRequestRows = extractFirewallRequests(payload.nodes, payload.edges).map(
    (row, index) => ({
      ...
      sourceCompute: row.sourceCompute,
      sourceComponent: row.sourceComponent,
      destZone: row.destZone,
      destRegion: row.destRegion,
      destCompute: row.destCompute,
  ...
  const FIREWALL_REQUEST_COLUMNS = [
    ...
    { header: "Source Region", key: "sourceRegion" },
    { header: "Source Compute", key: "sourceCompute" },
    { header: "Source Component", key: "sourceComponent" },
    { header: "Dest Zone", key: "destZone" },
    { header: "Dest Region", key: "destRegion" },
    { header: "Dest Compute", key: "destCompute" },
    { header: "Dest Component", key: "destComponent" },
